...
read.csv("logs_cleaned/layer_drop_core_benchmark.csv") %>% 
  mutate(n_layer_drop = factor(n_layer_drop)) %>%
ggplot() +
  ...
  scale_fill_manual(values = c("#2E4C6D", "#396EB0", "#86C6F4")) -> p
ggsave(p, filename = "plots/layer_drop_comparison.png", dpi=300, width=8.57, height=6.72)
```
