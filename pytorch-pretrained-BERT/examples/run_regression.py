...
import sys
sys.path.append("/data/sls/qcri/mt/work/hsajjad/software/transformers_new/")
...
import sys
sys.path.insert(0,'/content/drive/MyDrive/are-16-heads-really-better-than-1/pytorch-pretrained-BERT')
...
#        print (list(model.roberta.embeddings.parameters()))
    #    print (len(list(model.transformer.word_embedding.parameters())))
    #print (list(model.bert.embeddings.parameters()))
#        print (list(model.roberta.encoder.layer))
#        print (len(model.roberta.encoder.layer))
#    sys.exit(1)
    ...
    for i in range(1,13):
      for j in range(1,13):
        attention_mask_heads = [str(i)+":"+str(j)]
        print("attention_head_mask",attention_mask_heads)
        to_prune = pruning.parse_head_pruning_descriptors(
                attention_mask_heads,
